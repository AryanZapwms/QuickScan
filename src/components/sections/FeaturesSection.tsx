      ...
      <div className="container-custom px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
          {features.map((feature, index) => (
            <div 
              key={index} 
              className="p-4 md:p-5 rounded-lg border border-border hover:border-primary/30 hover:shadow-sm transition duration-300 group"
            >
        ...
        {/* CTA Banner */}
        <div className="mt-8 md:mt-12 bg-primary rounded-lg md:rounded-xl p-6 md:p-8 text-primary-foreground">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-4">
            ...
            <div className="mt-4 lg:mt-0">
              <button className="bg-background border-0 text-primary hover:bg-secondary transition duration-300 font-bold py-2.5 px-6 rounded-lg text-sm md:text-base w-full sm:w-auto">
                Book Home Service
              </button>
            </div>
          </div>
