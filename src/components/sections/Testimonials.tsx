...
const Testimonials = () => {
  ...
  return (
    <section className="py-8 md:py-12 bg-secondary/30 border-y border-border">
      <div className="container-custom px-4 md:px-6">
        ...
        <div className="relative max-w-4xl mx-auto">
          <div className="bg-white rounded-lg md:rounded-xl shadow-lg p-6 md:p-8">
            <div className="flex items-start mb-4 md:mb-6">
              <div className="w-12 h-12 md:w-14 md:h-14 bg-secondary rounded-full flex items-center justify-center mr-4 flex-shrink-0 border border-border">
                ...
                {testimonials.map((_, index) => (
                  <button
                    ...
                    className={`w-2 h-2 rounded-full transition ${
                      index === currentIndex ? 'bg-primary scale-125' : 'bg-border'
                    }`}
        ...
        <div className="mt-8 md:mt-10 grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
          <div className="text-center p-3 md:p-4 bg-white rounded-lg border border-border">
            <div className="text-xl md:text-2xl font-bold text-primary mb-1">4.8/5</div>
            <div className="text-muted-foreground text-xs md:text-sm">Customer Rating</div>
          </div>
          <div className="text-center p-3 md:p-4 bg-white rounded-lg border border-border">
            <div className="text-xl md:text-2xl font-bold text-primary mb-1">99%</div>
            <div className="text-muted-foreground text-xs md:text-sm">Report Accuracy</div>
          </div>
          <div className="text-center p-3 md:p-4 bg-white rounded-lg border border-border">
            <div className="text-xl md:text-2xl font-bold text-primary mb-1">98%</div>
            <div className="text-muted-foreground text-xs md:text-sm">On-Time Delivery</div>
          </div>
          <div className="text-center p-3 md:p-4 bg-white rounded-lg border border-border">
            <div className="text-xl md:text-2xl font-bold text-primary mb-1">24/7</div>
            <div className="text-muted-foreground text-xs md:text-sm">Customer Support</div>
          </div>
        </div>
      </div>
    </section>
